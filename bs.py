...
def get_filters():
    ...
    while True:
        ...
        month = input('Enter any of these (January, February, March, April, May, June), or "all" for all months').lower()
        print()
        ...
        day = input('Enter any of these days (Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday) or all for all days').lower()
